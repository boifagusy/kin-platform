...
class NotificationService
{
    ...
    public function sendSosSms(string $phone, string $message): bool
    {
        if (!($this->settings['sms_enabled'] ?? false)) {
            Log::info('[SOS-SMS] Disabled by admin settings', ['phone' => $phone]);
            return false;
        }
    ...
    public function sendSosWhatsApp(string $phone, string $message): bool
    {
        if (!($this->settings['whatsapp_enabled'] ?? false)) {
            Log::info('[SOS-WhatsApp] Disabled by admin settings', ['phone' => $phone]);
            return false;
        }
