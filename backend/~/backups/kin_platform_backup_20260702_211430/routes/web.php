...
Route::prefix('pulse')->middleware(['auth'])->group(function () {
    Route::get('/dashboard', [App\Http\Controllers\Pulse\PulseDashboardController::class, 'dashboard'])
...
Route::prefix('guardian')->middleware(['auth'])->group(function () {
    Route::get('/dashboard', [GuardianDashboardController::class, 'dashboard'])
        ->name('guardian.dashboard');
    Route::get('/api/status', [GuardianDashboardController::class, 'apiStatus']);
    Route::get('/api/timeline', [GuardianDashboardController::class, 'apiTimeline']);
});

// Recovery Routes
Route::prefix('recovery')->middleware(['auth'])->group(function () {
    Route::get('/dashboard', [RecoveryController::class, 'dashboard'])
        ->name('recovery.dashboard');
    Route::post('/run-policy', [RecoveryController::class, 'runPolicy']);
    Route::get('/stats', [RecoveryController::class, 'getStats']);
    Route::get('/attempts', [RecoveryController::class, 'getAttempts']);
});

// ============================================================
// PLATFORM ROUTES (Guardian, Pulse, Recovery)
// ============================================================
