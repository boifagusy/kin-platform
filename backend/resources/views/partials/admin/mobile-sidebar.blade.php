<div id="mobileSidebar" class="fixed left-0 top-16 h-[calc(100vh-64px)] w-64 z-50 overflow-y-auto bg-white border-r border-gray-200 shadow-lg transform -translate-x-full transition-transform duration-300 md:hidden">
