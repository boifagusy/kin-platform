...
class SosController extends Controller
{
    ...
    protected function processSOS(Request $request)
    {
        try {
            ...
            // Create SOS event
            // Flag suspicious SOS based on device trust
            ...
            $incident = SafetyIncident::create([
                ...
                'status' => 'active',
                'is_duress' => $request->is_duress ?? false,
                'description' => $request->is_duress
                    ? 'Duress SOS triggered'
                    : ($isSuspicious ? 'SOS triggered — low device trust (possible false alarm)' : 'SOS triggered by user'),
